...
var $ = __webpack_require__(9931);
var $trim = (__webpack_require__(5272).trim);
var forcedStringTrimMethod = __webpack_require__(2985);
...
function createElement(options) {
  ...
  var element = document.createElement(name || 'div');
  if (id) {
    element.id = id;
  }
  if (classes) {
...
var es_date_now = __webpack_require__(5032);
...
var es_string_trim = __webpack_require__(925);
...
;// CONCATENATED MODULE: ./src/js/message/img/eye.png
const eye_namespaceObject = __webpack_require__.p + "36ec079c3e3d834f47f9.png";
;// CONCATENATED MODULE: ./src/js/message/Message.js
...
var Message = /*#__PURE__*/function () {
  ...
  _createClass(Message, [{
    key: "init",
    value: function init() {
      this.messageEl = createElement_createElement({
        classes: ['msg']
      });
      var container = createElement_createElement({
        classes: ['msg__container']
      });
      var headerEl = createElement_createElement({
        classes: ['msg__header']
      });
      var dateEl = createElement_createElement({
        classes: ['msg__date'],
        text: formatDate(this.data.created)
      });
      headerEl.appendChild(dateEl);
      container.appendChild(headerEl);
      var contentEl = createElement_createElement({
        classes: ['msg__content'],
        text: this.data.text
      });
      container.appendChild(contentEl);
      var coordsWrapEl = createElement_createElement({
        classes: ['msg__footer']
      });
      var coordsEl = createElement_createElement({
        classes: ['msg__coords'],
        text: this.data.coords
      });
      coordsWrapEl.appendChild(coordsEl);
      var iconEl = createElement_createElement({
        classes: ['msg__icon']
      });
      var imageIcon = createElement_createElement({
        name: 'img',
        attributes: [{
          name: 'src',
          value: eye_namespaceObject
        }]
      });
...
var Modal = /*#__PURE__*/function () {
  ...
  Modal_createClass(Modal, [{
    key: "init",
    value: function init() {
      this.modalEl = createElement_createElement({
        classes: ['modal']
      });
      var header = createElement_createElement({
        classes: ['modal__header']
      });
      var title = createElement_createElement({
        classes: ['modal__title'],
        text: this.title || 'Модальное окно'
      });
      header.appendChild(title);
      this.modalEl.appendChild(header);
      var content = createElement_createElement({
...
;// CONCATENATED MODULE: ./src/js/utils/extractCoords.js


/* eslint-disable no-useless-escape */
var extractCoords = function extractCoords(str) {
  var res;
  var banList = str.replace(/[\d\.,\[\]\- ]+/g, '');
  if (banList) {
    res = {
      error: 'Будь умницей, используй только цифры, запятую и точку'
    };
    return res;
  }
  var coords = str.replace(/[\[\] ]+/g, '').split(',');
  if (coords.length !== 2) {
    res = {
...
/* harmony default export */ const utils_extractCoords = (extractCoords);
...
function _defineProperty(obj, key, value) { key = Timeline_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function Timeline_toPropertyKey(t) { var i = Timeline_toPrimitive(t, "string"); return "symbol" == Timeline_typeof(i) ? i : String(i); }
...
var Timeline = /*#__PURE__*/function () {
  function Timeline(parent) {
    ...
    _defineProperty(this, "onSubmit", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
        var form, formData, position, coords;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              form = _this.timelineEl.querySelector('.timeline__form');
              formData = new FormData(form);
              _this.msgData.text = formData.get('text');
            ...
            case 12:
              _this.msgData.coords = "[".concat(coords.latitude, ", ").concat(coords.longitude, "]");
            case 13:
              if (_this.msgData.coords) {
                _this.addMsg();
              } else {
                _this.getCoords();
              }
  ...
  Timeline_createClass(Timeline, [{
    key: "init",
    value: function init() {
      this.timelineEl = createElement_createElement({
        classes: ['timeline']
      });
      var contentEl = createElement_createElement({
        classes: ['timeline__content']
      });
      var lineEl = createElement_createElement({
        classes: ['timeline__line']
      });
      contentEl.appendChild(lineEl);
      this.timelineEl.appendChild(contentEl);
      var msgBarEL = createElement_createElement({
        classes: ['timelien__messageBar']
      });
      var form = createElement_createElement({
        name: 'form',
        classes: ['timeline__form']
      });
      var groupEl = createElement_createElement({
        classes: ['timeline__group']
      });
      var input = createElement_createElement({
        name: 'input',
    ...
    key: "addMsg",
    value: function addMsg() {
      var content = this.timelineEl.querySelector('.timeline__content');
      var msg = new Message(content, this.msgData);
      msg.bindToDOM();
      var height = content.scrollHeight;
      var lineEl = content.querySelector('.timeline__line');
      lineEl.style.height = "".concat(height, "px");
      var form = this.timelineEl.querySelector('.timeline__form');
      form.reset();
    }
  }, {
    key: "getCoords",
    value: function getCoords() {
      ...
      var descr = createElement_createElement({
      ...
      var groupInput = createElement_createElement({
        classes: ['form__group']
      });
      var inputTitle = createElement_createElement({
      ...
      var groupBtn = createElement_createElement({
        classes: ['form__btns']
      });
      var submit = createElement_createElement({
        name: 'button',
        classes: ['form__btn', 'form__btn_submit'],
        text: 'ok'
      });
      groupBtn.appendChild(submit);
      var cancel = createElement_createElement({
        name: 'button',
      ...
      var showHint = function showHint(text) {
        var hint = createElement_createElement({
          classes: ['form__hint'],
          text: text
        });
      ...
      form.onsubmit = function (e) {
        ...
        var coordsText = formData.get('coords');
        var currentHint = groupInput.querySelector('.form__hint');
        if (currentHint) currentHint.remove();
        var coords = utils_extractCoords(coordsText);
        if (coords.error) {
          input.focus();
          showHint(coords.error);
          return;
        }
        _this2.msgData.coords = "[".concat(coords.latitude, ", ").concat(coords.longitude, "]");
        _this2.addMsg();
        _this2.modal.remove();
        _this2.modal = null;
      };
